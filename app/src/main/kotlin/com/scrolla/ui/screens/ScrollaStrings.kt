...
object ScrollaStrings {
    ...
    // Onboarding â€” Phase 1: The Question
    ...
    // Onboarding â€” Phase 2: The Reveal
    ...
    // Onboarding â€” Phase 3: The Invitation
    ...
    const val PERMISSION_WHY_BODY = "Android's Accessibility feature lets Scrolla read scroll events â€” the same system used by apps like TalkBack for screen readers. Scrolla only reads how far views scroll, not what's on screen. You can turn this off at any time in Settings â†’ Accessibility."
    ...
    const val GROUP_JOIN_ERROR_NOT_FOUND = "Group not found â€” check the code and try again"
    const val GROUP_JOIN_ERROR_OWN_CODE = "That's your own group code â€” share it with a friend to invite them"
    ...
    const val GROUP_SKIP = "Skip for now â€” you can join a group later"
    ...
    const val LEADERBOARD_HALL_OF_FAME_LINK = "Hall of fame â†’"
    ...
    const val LEADERBOARD_NO_DATA = "No data yet â€” start scrolling"
    const val LEADERBOARD_LEFT_GROUP_SUFFIX = "(left)"

    // Error states (shared)
    const val ERROR_NO_CONNECTION = "No connection â€” showing last saved data"
    const val ERROR_COULDNT_LOAD = "Couldn't load â€” showing last known ranking"
    const val ERROR_RETRY = "Something went wrong â€” tap to retry"
    const val ERROR_CANT_SYNC = "Couldn't sync â€” will retry automatically"
    ...
    const val PROFILE_PERSONAL_BEST_LINK = "Personal records â†’"
    const val PROFILE_HALL_OF_FAME_LINK = "Hall of fame â†’"
    const val PROFILE_HALL_OF_FAME_RECORD_HOLDER = "You hold the group's best day"
    const val PROFILE_HALL_OF_FAME_EMPTY = "No record set yet â€” be the first"
    const val PROFILE_GROUPS_LINK = "Manage groups â†’"
    ...
    const val SETTINGS_HEALTH_STOPPED_BODY = "The accessibility permission was turned off â€” Scrolla can't measure distance without it"
    ...
    const val SETTINGS_HEALTH_DEGRADED_BODY = "Scrolla is enabled but hasn't received recent scroll events â€” this may be a battery restriction"
    ...
    const val SETTINGS_HEALTH_INTERRUPTED_BODY_TEMPLATE = "Your phone may have stopped Scrolla to save battery â€” this is common on %s devices"
    ...
    const val SETTINGS_BATTERY_SECTION_TEMPLATE = "Battery settings â€” your phone: %s"
    ...
    const val SETTINGS_DELETE_ERROR = "Couldn't delete your account â€” try again or contact support"
    ...
    const val JOIN_GROUP_ERROR_NOT_FOUND = "Group not found â€” check the code"
    ...
    const val APP_BREAKDOWN_SUBTITLE = "Today's scroll by app â€” stays on your device"
    ...
    const val APP_BREAKDOWN_EMPTY = "No app data yet today â€” keep scrolling"
